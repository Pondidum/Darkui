...
if S.loot.enable ~= true then return end
...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(S.fonts.unitframe, 12, "OUTLINE")
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture(S.textures.normal)
	...
	bind:SetFont(S.fonts.unitframe, 12, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(S.fonts.unitframe, 12, "OUTLINE")
...
label:SetFont(S.fonts.unitframe, 12, "OUTLINE")
