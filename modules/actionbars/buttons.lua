...
local function ShowOrHideBar(bar, button)
	...
	if bar:IsShown() then
		if bar == TukuiBar5 and T.lowversion then
			if button == TukuiBar5ButtonTop then
				if TukuiBar7:IsShown() then
					TukuiBar7:Hide()
					bar:SetWidth((S.actionbars.buttonsize * 2) + (S.actionbars.buttonspacing * 3))
					db.hidebar7 = true
				elseif TukuiBar6:IsShown() then
					TukuiBar6:Hide()
					bar:SetWidth((S.actionbars.buttonsize * 1) + (S.actionbars.buttonspacing * 2))
					db.hidebar6 = true
				else
					bar:Hide()
				end
				...
				if button == TukuiBar5ButtonBottom then
					...
					elseif not TukuiBar6:IsShown() then
						...
						TukuiBar7:Show()
						bar:SetWidth((S.actionbars.buttonsize * 3) + (S.actionbars.buttonspacing * 4))
						db.hidebar7 = false
					end
				end
			end
		...
		if bar == TukuiBar5 and T.lowversion then
			...
			elseif TukuiBar6:IsShown() then
				TukuiBar6:Show()
				TukuiBar5:SetWidth((S.actionbars.buttonsize * 2) + (S.actionbars.buttonspacing * 3))
			else
				bar:Show()
			end
		else
...
init:SetScript("OnEvent", function(self, event)
	...
	if T.lowversion then
		...
		if db.hidebar6 then
			TukuiBar6:Hide()
			TukuiBar5:SetWidth((S.actionbars.buttonsize * 1) + (S.actionbars.buttonspacing * 2))
		end
