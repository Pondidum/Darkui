...
vehicleleft:SetPoint("TOPRIGHT", DarkuiActionBarBackground, "TOPLEFT", -S.actionbars.buttonspacing, 0)
...
vehicleright:SetPoint("TOPLEFT", DarkuiActionBarBackground, "TOPRIGHT", S.actionbars.buttonspacing, 0)
