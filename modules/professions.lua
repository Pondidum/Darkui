...
if S.utilities.professions.doublewidth ~= true then return end
...
local function OnAddonLoaded(self, event, addon)
	...
	if addon == "Blizzard_TradeSkillUI" then
		E:Unregister("ADDON_LOADED", "Darkui_professions_AddonLoaded")
...
E:Register("ADDON_LOADED", OnAddonLoaded, "Darkui_professions_AddonLoaded")