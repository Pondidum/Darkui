...
local Path = function(self, ...)
	return (self.DarkTotems.Override or UpdateTotem) (self, ...)
end
...
local ThrottledUpdate = function(self, event)
...
local Enable = function(self)
	...
	if(totems) then
		...
		self:SetScript("OnUpdate", ThrottledUpdate)
...
oUF:AddElement("DarkTotems", Update, Enable, Disable)
